...
exports.getCampgrounds = async (req, res, next) => {
    ...
    query = Campground.find(JSON.parse(queryStr)).populate('bookings', 'date user -_id');
...
exports.getCampground = async (req, res, next) => {
    try {
        const campground = await Campground.findById(req.params.id).populate('bookings', 'date user -_id');
